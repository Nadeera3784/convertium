...
const ThemeSwitch = ({ sun, setSun }) => {
  ...
  return (
    ...
    <label className="relative cursor-pointer p-2" htmlFor="light-switch">
      <svg className="dark:hidden" width="16" height="16" xmlns="http://www.w3.org/2000/svg" onClick={toggleDarkMode}>
        <path
      ...
      <svg className="hidden dark:block" width="16" height="16" xmlns="http://www.w3.org/2000/svg" onClick={toggleDarkMode}>
